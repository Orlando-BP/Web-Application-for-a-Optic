...
$modificarClientes = "update clientes set nombre='$nombre', telefono='$telefono' where id_cliente = $id_cliente";
$resultadoclientes = pg_query($conexion,$modificarClientes);
?>
